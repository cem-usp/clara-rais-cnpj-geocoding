...
This report presents a reproducible pipeline for processing and [geocoding](https://en.wikipedia.org/wiki/Address_geocoding) [CNPJ](https://en.wikipedia.org/wiki/CNPJ)s from the Annual Social Information Report ([RAIS](https://www.rais.gov.br/)) of the Brazilian Ministry of Labor and Employment ([MTE](https://www.gov.br/trabalho-e-emprego)). The pipeline was developed in the [R programming language](https://www.r-project.org/) by **Gabriel Caldeira** and **Clara Penz**, with further adaptations by [**Daniel Vartanian**](https://github.com/danielvartan). It is intended for internal use by the Center for Metropolitan Studies ([CEM](https://centrodametropole.fflch.usp.br/)) team.

The original files are available in the [`R`](https://github.com/cem-usp/clara-rais-cnpj-geocoding/tree/main/R) folder of the pipeline’s code repository. For instructions on how to run the pipeline, see the repository [README](https://github.com/cem-usp/clara-rais-cnpj-geocoding/blob/main/README.md).

Comments are included in text blocks and are presented in Portuguese.

::: {.callout-important}
This pipeline is deprecated. Click [here](https://cem-usp.github.io/rfb-cnpj-geocoding/) to see the new version.
:::
...
cnae <-
  read_sheet(
    ss = "1Rn_-O6k3Kr7W-CCRG2aj8ryKq_-yy5lA53NDmXtQamQ",
    sheet = "Dataset"
  ) |>
  mutate(
    uf   = sigla_uf,
